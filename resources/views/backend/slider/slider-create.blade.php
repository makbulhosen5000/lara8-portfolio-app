        ...
        <form action="{{(@$editData)?route('sliders.update',$editData->id):route('sliders.store')}} " method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group">
                  ...
                  <img src="{{(!empty($editData->image))?url('public/images/slider_images/'.$editData->image):url('public/images/not_found_img.png')}}" id="image" style="width:540px;height:200px">

        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('contacts.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="my-input" class="form-control" type="url" name="facebook" placeholder="Enter Your Facebook Account" required>
                       <font style="color:red">{{($errors->has('facebook'))?($errors->first('facebook')):''}} </font>
                </div>
                <div class="form-group">
                    <label for="my-input">Twitter</label>
                    <input id="my-input" class="form-control" type="url" name="twitter" placeholder="Enter Your Twitter Account" required>
                       <font style="color:red">{{($errors->has('twitter'))?($errors->first('twitter')):''}} </font>
                </div>
                <div class="form-group">
                    <label for="my-input">Linkedin</label>
                    <input id="my-input" class="form-control" type="url" name="linkedin" placeholder="Enter Your Linkedin Account" required>
                       <font style="color:red">{{($errors->has('linkedin'))?($errors->first('linkedin')):''}} </font>
                </div>
                <div class="form-group">
                    <label for="my-input">Youtube</label>
                    <input id="my-input" class="form-control" type="url" name="youtube" placeholder="Enter Your Youtube Account" required>
